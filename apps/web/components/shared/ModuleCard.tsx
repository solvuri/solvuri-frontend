  ...
  return (
    <div className="bg-[#16153D] rounded-2xl flex flex-col md:flex-row overflow-hidden border border-[#7C6EFF]/10 transition-all hover:border-[#7C6EFF]/30">
      ...
      <div className="flex-1 flex flex-col p-6 md:p-8">
        <div className="mb-3">
          <span
            className="text-[10px] uppercase tracking-[0.2em] font-bold px-3 py-1 rounded-full inline-block"
            style={{
              color: props.accentColor,
              backgroundColor: `${props.accentColor}26`, // ~15% opacity tint
            }}
          >
            {props.category}
          </span>
        ...
        <div className="mt-auto">
          ...
          >
            <Button
              variant="accent"
              className="text-[#0F0E2A] cursor-pointer w-full py-2.5 rounded-full font-bold transition-transform hover:scale-[1.02]"
